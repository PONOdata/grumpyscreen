...
# Pono Print: canned animation frame data (lv_animimg flipbooks), generated by
# tools/gen_pono_spinner.py. Committed .c; the .py is for refresh.
CSRCS 			+= $(wildcard $(LVGL_DIR)/assets/pono/anim/*.c)
